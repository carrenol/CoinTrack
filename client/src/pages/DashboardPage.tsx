    ...
    <div className="min-h-screen bg-gray-950 text-white flex">
      ...
      <div className="w-72 bg-gray-900 border-r border-gray-800 flex flex-col">
        ...
        <nav className="flex-1 p-4">
          <div className="space-y-1">
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-800 text-white">
              📊 Top Criptos
            </div>
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-800 text-gray-400 hover:text-white transition">
              ⭐ Mis Favoritos
            </div>
            {isAdmin && (
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-800 text-emerald-400">
                👑 Admin Panel
              </div>
            )}
          </div>
      ...
      <div className="flex-1">
        <header className="h-16 bg-gray-900 border-b border-gray-800 flex items-center justify-between px-8">
          <h2 className="text-2xl font-semibold">Top 10 Criptomonedas</h2>
          <button onClick={handleLogout} className="px-5 py-2 bg-red-600 hover:bg-red-700 rounded-xl">Cerrar Sesión</button>
        </header>

        <main className="p-8">
          {isAdmin && (
            <div className="bg-emerald-900/50 border border-emerald-500 p-4 rounded-2xl mb-8">
